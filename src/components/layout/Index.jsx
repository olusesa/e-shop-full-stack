    ...
    <div className="container">
        ...
        <div className="row">
            ...
            <div className="col-md-4 col-xs-6">
                <div className="shop">
                    <div className="shop-img">
                        <img src="/src/assets/img/shop02.png" alt=""/>
                    </div>
                    <div className="shop-body">
                            ...
                            <div className="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product01.png" alt=""/>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product02.png" alt=""/>
                                        <div className="product-label">
                                            <span className="new">NEW</span>
                                        </div>
                                    </div>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product03.png" alt=""/>
                                        <div className="product-label">
                                            <span className="sale">-30%</span>
                                        </div>
                                    </div>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product04.png" alt=""/>
                                    </div>
                                    <div className="product-body">
                                        <p className="product-category">Category</p>
                                        <h3 className="product-name"><a href="#">product name goes here</a></h3>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product05.png" alt=""/>
                                    </div>
                                    <div className="product-body">
                                        <p className="product-category">Category</p>
                                        <h3 className="product-name"><a href="#">product name goes here</a></h3>
                    ...
                    <div className="products-tabs">
                        ...
                        <div id="tab2" className="tab-pane fade in active">
                            <div className="products-slick" data-nav="#slick-nav-2">
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product06.png" alt=""/>
                                        <div className="product-label">
                                            <span className="sale">-30%</span>
                                            <span className="new">NEW</span>
                                        </div>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product07.png" alt=""/>
                                        <div className="product-label">
                                            <span className="new">NEW</span>
                                        </div>
                                    </div>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product08.png" alt=""/>
                                        <div className="product-label">
                                            <span className="sale">-30%</span>
                                        </div>
                                    </div>
                                ...
                                <div className="product">
                                    <div className="product-img">
                                        <img src="/src/assets/img/product09.png" alt=""/>
                                    </div>
                                    <div className="product-body">
                                        <p className="product-category">Category</p>
                                        <h3 className="product-name"><a href="#">product name goes here</a></h3>
